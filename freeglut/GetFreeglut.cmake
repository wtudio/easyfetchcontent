...
if(NOT TARGET freeglut::freeglut)
  if (TARGET freeglut_static)
    ...
    target_include_directories(freeglut_static INTERFACE ${freeglut_SOURCE_DIR}/include/GL)
  elseif (TARGET freeglut)
    add_library(freeglut::freeglut ALIAS freeglut)
    target_include_directories(freeglut INTERFACE ${freeglut_SOURCE_DIR}/include/GL)
  endif ()
endif ()
