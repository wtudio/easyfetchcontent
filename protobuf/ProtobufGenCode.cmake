...
function(add_protobuf_gencode_for_path_target)
  ...
  foreach(PROTO_FILE ${PROTO_FILES})
    ...
    add_custom_command(
      ...
      ARGS ${ARG_OPTIONS} --proto_path=${ARG_PROTO_PATH} ${PROTOC_EXTERNAL_PROTO_PATH_ARGS} --cpp_out=${ARG_GENCODE_PATH} ${PROTO_FILE}
  ...
  target_sources(${ARG_TARGET_NAME} INTERFACE
    FILE_SET HEADERS
    BASE_DIRS ${ARG_GENCODE_PATH}
    FILES ${GEN_HDRS}
  )
  target_link_libraries(${ARG_TARGET_NAME} INTERFACE ${ALL_DEP_PROTO_TARGETS})
...
function(add_protobuf_gencode_for_one_file_target)
  ...
  add_custom_command(
    OUTPUT ${GEN_SRC} ${GEN_HDR}
    COMMAND protobuf::protoc
    ARGS ${ARG_OPTIONS} --proto_path=${PROTO_PATH} ${PROTOC_EXTERNAL_PROTO_PATH_ARGS} --cpp_out=${ARG_GENCODE_PATH} ${ARG_PROTO_FILE}
